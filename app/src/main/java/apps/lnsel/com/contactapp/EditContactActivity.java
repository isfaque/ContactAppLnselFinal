...
public class EditContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(ContactsData.current_cntImageStatus.equals("true")){

            ImageLoader imageLoader = AppController.getInstance().getImageLoader();
            imageLoader.get(ContactsData.current_cntImage, new ImageLoader.ImageListener() {
        ...
        ib_contact_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hasPermissionRead = (ContextCompat.checkSelfPermission(EditContactActivity.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED);
                if (!hasPermissionRead) {
                ...
                hasPermissionCamera = (ContextCompat.checkSelfPermission(EditContactActivity.this,
                        Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED);
                if (!hasPermissionCamera) {
                    ActivityCompat.requestPermissions(EditContactActivity.this,
                            new String[]{Manifest.permission.CAMERA},
            ...
            public void onClick(View v) {
                ...
                if(photo_bitmap!=null) {
                    ...
                    if(isNetworkAvailable()){
                        ...
                        updateContactWebService(cntImageStatus);
                    }else {
                        Toast.makeText(EditContactActivity.this, "Please check Internet Connection", Toast.LENGTH_LONG);
                    }
    ...
    public void updateContactWebService(final String cntImageStatus){
